...
const VolunteerHoursForm = ({ navigation }: any) => {
  ...
  const clubEvents = [
    { label: 'Beach Cleanup Day', value: 'beach_cleanup' },
    { label: 'Food Drive', value: 'food_drive' },
    { label: 'Tutoring Program', value: 'tutoring' },
  ...
  const handleSubmit = () => {
    ...
    console.log('Submitting hours:', submissionData);
          ...
          >
            ...
            <View style={styles.formContainer}>
              ...
              <TouchableOpacity style={styles.submitButton} onPress={handleSubmit}>
                <Text style={styles.submitButtonText}>Submit Hours</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
        </KeyboardAvoidingView>
